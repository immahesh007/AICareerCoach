                  ...
                  <tr key={a.id} className="border-b border-white/5 last:border-0 hover:bg-white/5 transition-colors">
                    ...
                    <td className="px-6 py-4">
                      <div className="flex items-center justify-end gap-2 flex-wrap">
                        ...
                        <button
                          onClick={() => router.push(`/resumes/${a.resume_id}/analyses/${a.id}/suggestions`)}
                          className="px-3 py-1.5 rounded-full bg-amber-500 hover:bg-amber-400 text-indigo-950 text-xs font-semibold transition-colors"
                        >
                          Improve with AI
                        </button>
                        <button
              ...
              {data.analyses.map((a) => (
                <li key={a.id} className="px-5 py-4 space-y-3">
                  ...
                  <div className="flex flex-wrap gap-2">
                    ...
                    <button
                      onClick={() => router.push(`/resumes/${a.resume_id}/analyses/${a.id}/suggestions`)}
                      className="px-3 py-1.5 rounded-full bg-amber-500 hover:bg-amber-400 text-indigo-950 text-xs font-semibold"
                    >
                      Improve with AI
                    </button>
                    <button
