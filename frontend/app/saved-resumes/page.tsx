...
function SavedResumesContent() {
  ...
  const handleEdit = (id: string) => router.push(`/resume-builder?saved_resume_id=${id}`);
                    ...
                    <td className="px-4 py-3">
                      <div className="flex items-center justify-end gap-2">
                        ...
                        <button
                          ...
                          className="px-3 py-1.5 rounded-full bg-violet-600 hover:bg-violet-500 text-white text-[11px] font-semibold transition-colors inline-flex items-center gap-1.5"
                        >
                          <svg className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
